...
module.exports = app => {
  // CREATE COURSE
  app.post("/schools/:schoolSlug/courses/new",
  ...
  // READ COURSE
  app.get("/schools/:schoolSlug/courses/:courseSlug",
    passport.authenticate('headerapikey',
      { session: false, failureRedirect: '/unauthorized' }
    ),
    async (req, res) => {
  ...
  // UPDATE COURSE
  app.patch("/schools/:schoolSlug/courses/:courseSlug/edit_department",
    passport.authenticate('headerapikey',
      { session: false, failureRedirect: '/unauthorized' }
    ),
    async (req, res) => {
  ...
  app.patch("/schools/:schoolSlug/courses/:courseSlug/edit_code",
    passport.authenticate('headerapikey',
      { session: false, failureRedirect: '/unauthorized' }
    ),
    async (req, res) => {
  ...
  app.patch("/schools/:schoolSlug/courses/:courseSlug/edit_name",
    passport.authenticate('headerapikey',
      { session: false, failureRedirect: '/unauthorized' }
    ),
    async (req, res) => {
  ...
  app.patch("/schools/:schoolSlug/courses/:courseSlug/edit_description",
    passport.authenticate('headerapikey',
      { session: false, failureRedirect: '/unauthorized' }
    ),
    async (req, res) => {
  ...
  app.patch("/schools/:schoolSlug/courses/:courseSlug/edit_units",
    passport.authenticate('headerapikey',
      { session: false, failureRedirect: '/unauthorized' }
    ),
    async (req, res) => {
  ...
  app.put("/schools/:schoolSlug/courses/:courseSlug",
    passport.authenticate('headerapikey',
      { session: false, failureRedirect: '/unauthorized' }
    ),
    async (req, res) => {
  ...
  app.patch("/schools/:schoolSlug/courses/:courseOneSlug/add_prerequisite/:courseTwoSlug",
    passport.authenticate('headerapikey',
      { session: false, failureRedirect: '/unauthorized' }
    ),
    async (req, res) => {
  ...
  app.patch("/schools/:schoolSlug/courses/:courseOneSlug/delete_prerequisite/:courseTwoSlug",
    passport.authenticate('headerapikey',
      { session: false, failureRedirect: '/unauthorized' }
    ),
    async (req, res) => {
  ...
  app.patch("/schools/:schoolSlug/courses/:courseOneSlug/add_corequisite/:courseTwoSlug",
    passport.authenticate('headerapikey',
      { session: false, failureRedirect: '/unauthorized' }
    ),
    async (req, res) => {
  ...
  app.patch("/schools/:schoolSlug/courses/:courseOneSlug/delete_corequisite/:courseTwoSlug",
    passport.authenticate('headerapikey',
      { session: false, failureRedirect: '/unauthorized' }
    ),
    async (req, res) => {
  ...
  // DELETE COURSE
  app.delete("/schools/:schoolSlug/courses/:courseSlug",
    passport.authenticate('headerapikey',
      { session: false, failureRedirect: '/unauthorized' }
    ),
    async (req, res) => {
